...
//		Stereotype str = chessIoTProfile.getOwnedStereotype("ContractRefinement");
//		return str;
//	}
	
	public static Stereotype getPayload(ResourceSet res) {
		loadCHESSIoTProfile(res);
		Stereotype str = chessIoTProfile.getOwnedStereotype("Payload");
		return str;
	}
	
	public static Stereotype getCommunicationMode() {
		Stereotype str = chessIoTProfile.getOwnedStereotype("CommunicationMode");
		return str;
	}
	
	public static Stereotype geIoTPortStereotype() {
		Stereotype str = chessIoTProfile.getOwnedStereotype("IoTPort");
		return str;
	}
	
	public static Stereotype geIoTSensorBlock() {
		Stereotype str = chessIoTProfile.getOwnedStereotype("SensorBlock");
		return str;
	}
	
	public static Stereotype getPayloadParams(ResourceSet res) {
		loadCHESSIoTProfile(res);
		Stereotype str = chessIoTProfile.getOwnedStereotype("PayloadParameters");
		return str;
	}

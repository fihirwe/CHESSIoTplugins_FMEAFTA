 ...
 *   <li>{@link org.polarsys.chess.fla.flamm.Failure#getRaisedByRule <em>Raised By Rule</em>}</li>
 * </ul>
 * </p>
 *
...
public class Failure extends MinimalEObjectImpl.Container implements EObject {
	...
	/**
	 * The cached value of the '{@link #getRaisedByRule() <em>Raised By Rule</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRaisedByRule()
	 * @generated
	 * @ordered
	 */
	protected EList<Rule> raisedByRule;
	...
	/**
	 * Returns the value of the '<em><b>Raised By Rule</b></em>' reference list.
	 * The list contents are of type {@link org.polarsys.chess.fla.flamm.Rule}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Raised By Rule</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Raised By Rule</em>' reference list.
	 * @see org.polarsys.chess.fla.flamm.FlammPackage#getFailure_RaisedByRule()
	 * @model
	 * @generated
	 */
	public List<Rule> getRaisedByRule() {
		if (raisedByRule == null) {
			raisedByRule = new EObjectResolvingEList<Rule>(Rule.class, this, FlammPackage.FAILURE__RAISED_BY_RULE);
		}
		return raisedByRule;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case FlammPackage.FAILURE__RAISED_BY_RULE:
				return getRaisedByRule();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case FlammPackage.FAILURE__PREVIOUS_FAILURES:
				...
				return;
			case FlammPackage.FAILURE__RAISED_BY_RULE:
				getRaisedByRule().clear();
				getRaisedByRule().addAll((Collection<? extends Rule>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case FlammPackage.FAILURE__RAISED_BY_RULE:
				return raisedByRule != null && !raisedByRule.isEmpty();
		}

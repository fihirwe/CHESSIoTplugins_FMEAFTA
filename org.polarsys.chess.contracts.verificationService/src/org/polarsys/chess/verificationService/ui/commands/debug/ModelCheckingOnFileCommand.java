...
public class ModelCheckingOnFileCommand extends AbstractJobCommand {
	...
	private NuXmvExecService nuXmvService = NuXmvExecService.getInstance(ChessSystemModel.getInstance());
	...
	public void execPreJobOperations(ExecutionEvent event, IProgressMonitor monitor) throws Exception {
		...
		isProgrExec = waitJobExec(event);
		final NuXmvParametersDialog dialog = new NuXmvParametersDialog(null,null);
		dialog.open();

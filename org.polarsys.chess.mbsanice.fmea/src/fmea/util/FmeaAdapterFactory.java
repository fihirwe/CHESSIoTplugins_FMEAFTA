...
public class FmeaAdapterFactory extends AdapterFactoryImpl {
	...
	protected FmeaSwitch<Adapter> modelSwitch =
		new FmeaSwitch<Adapter>() {
			...
			@Override
			public Adapter caseInterPort(InterPort object) {
				return createInterPortAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fmea.Row <em>Row</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link fmea.InterPort <em>Inter Port</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createInterPortAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link fmea.Fmea <em>Fmea</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

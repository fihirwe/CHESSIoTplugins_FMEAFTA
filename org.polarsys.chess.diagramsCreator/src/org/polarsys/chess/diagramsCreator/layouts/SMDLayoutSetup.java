...
import org.polarsys.chess.diagramsCreator.connectors.SMDDiagramLayoutConnector;
...
public class SMDLayoutSetup implements ILayoutSetup {
	...
	public boolean supports(Object object) {
		...
		return getSMDDiagramEditor(object) != null || isEditPart(object);
	}
	...
	protected DiagramEditor getSMDDiagramEditor(Object object) {
		if (object == null) {
			return null;
		}
		...
		if (activeEditor instanceof DiagramEditor && activeEditor instanceof UmlStateMachineDiagramForMultiEditor) {
	...
	public Injector createInjector(final Module defaultModule) {
		return Guice.createInjector(Modules.override(defaultModule).with(new SMDLayoutModule()));
	}

	/**
	 * Guice module for the generic GMF connector.
	 */
	public static class SMDLayoutModule implements Module {

		@Override
		public void configure(final Binder binder) {
			binder.bind(IDiagramLayoutConnector.class).to(SMDDiagramLayoutConnector.class);

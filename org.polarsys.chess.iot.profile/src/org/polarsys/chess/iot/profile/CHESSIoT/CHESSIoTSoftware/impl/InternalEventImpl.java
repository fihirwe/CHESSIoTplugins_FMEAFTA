 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSoftware.impl.InternalEventImpl#getAction <em>Action</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalEventImpl extends EventImpl implements InternalEvent {
	/**
	...
	public EList<Action> getAction() {
		if (action == null) {
			action = new EObjectResolvingEList<Action>(Action.class, this, CHESSIoTSoftwarePackage.INTERNAL_EVENT__ACTION);
		}
		return action;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CHESSIoTSoftwarePackage.INTERNAL_EVENT__ACTION:
				return getAction();
		}

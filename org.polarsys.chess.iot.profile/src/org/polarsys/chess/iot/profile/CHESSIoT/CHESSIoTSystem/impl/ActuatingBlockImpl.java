...
public class ActuatingBlockImpl extends PhysicalElementImpl implements ActuatingBlock {
	 ...
	 * @ordered
	 */
	protected static final ActuatorType ACTUATION_TYPE_EDEFAULT = ActuatorType.LED;
	 ...
	 * @ordered
	 */
	protected ActuatorType actuationType = ACTUATION_TYPE_EDEFAULT;
	 ...
	 * @generated
	 */
	public ActuatorType getActuationType() {
	 ...
	 * @generated
	 */
	public void setActuationType(ActuatorType newActuationType) {
		ActuatorType oldActuationType = actuationType;
		actuationType = newActuationType == null ? ACTUATION_TYPE_EDEFAULT : newActuationType;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CHESSIoTSystemPackage.ACTUATING_BLOCK__ACTUATION_TYPE:
				setActuationType((ActuatorType)newValue);
				return;
			case CHESSIoTSystemPackage.ACTUATING_BLOCK__PHYSICALENTITY:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case CHESSIoTSystemPackage.ACTUATING_BLOCK__ACTUATION_TYPE:
				return actuationType != ACTUATION_TYPE_EDEFAULT;
			case CHESSIoTSystemPackage.ACTUATING_BLOCK__PHYSICALENTITY:

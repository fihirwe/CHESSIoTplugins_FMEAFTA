...
public class InternalRuntimeDslLexer extends Lexer {
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuntimeDsl.g:680:13: ( ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )? )
            // InternalRuntimeDsl.g:680:15: ( '0' .. '9' )* ( '.' ( '0' .. '9' )+ )?
            {
            // InternalRuntimeDsl.g:680:15: ( '0' .. '9' )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalRuntimeDsl.g:680:16: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            // InternalRuntimeDsl.g:680:27: ( '.' ( '0' .. '9' )+ )?
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    // InternalRuntimeDsl.g:680:28: '.' ( '0' .. '9' )+
                    {
                    match('.'); 
                    // InternalRuntimeDsl.g:680:32: ( '0' .. '9' )+
                    int cnt2=0;
                    loop2:
                    do {
                        int alt2=2;
                        ...
                        switch (alt2) {
                    	case 1 :
                    	    // InternalRuntimeDsl.g:680:33: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuntimeDsl.g:682:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalRuntimeDsl.g:682:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalRuntimeDsl.g:682:11: ( '^' )?
            int alt4=2;
            ...
            // InternalRuntimeDsl.g:682:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuntimeDsl.g:684:10: ( ( '0' .. '9' )+ )
            // InternalRuntimeDsl.g:684:12: ( '0' .. '9' )+
            {
            // InternalRuntimeDsl.g:684:12: ( '0' .. '9' )+
            int cnt6=0;
            loop6:
            do {
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalRuntimeDsl.g:684:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuntimeDsl.g:686:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalRuntimeDsl.g:686:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalRuntimeDsl.g:686:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalRuntimeDsl.g:686:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalRuntimeDsl.g:686:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
                    ...
                    break;
                case 2 :
                    // InternalRuntimeDsl.g:686:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalRuntimeDsl.g:686:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop8:
                    do {
                        int alt8=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuntimeDsl.g:688:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalRuntimeDsl.g:688:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalRuntimeDsl.g:688:24: ( options {greedy=false; } : . )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuntimeDsl.g:690:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalRuntimeDsl.g:690:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalRuntimeDsl.g:690:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop11:
            do {
                int alt11=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuntimeDsl.g:692:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalRuntimeDsl.g:692:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalRuntimeDsl.g:692:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt14=0;
            loop14:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalRuntimeDsl.g:694:16: ( . )
            // InternalRuntimeDsl.g:694:18: .
            {
            matchAny(); 

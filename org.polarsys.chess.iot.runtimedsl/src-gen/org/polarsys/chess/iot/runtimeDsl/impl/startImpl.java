 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.chess.iot.runtimeDsl.impl.startImpl#getService_name <em>Service name</em>}</li>
 *   <li>{@link org.polarsys.chess.iot.runtimeDsl.impl.startImpl#getMachine_name <em>Machine name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class startImpl extends ruleImpl implements start
{
  /**
  ...
  {
    return RuntimeDslPackage.Literals.START;
  }
  ...
  public void setService_name(String newService_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RuntimeDslPackage.START__SERVICE_NAME, oldService_name, service_name));
  }
  ...
  public void setMachine_name(String newMachine_name)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RuntimeDslPackage.START__MACHINE_NAME, oldMachine_name, machine_name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RuntimeDslPackage.START__SERVICE_NAME:
        return getService_name();
      case RuntimeDslPackage.START__MACHINE_NAME:

...
public class FlammPackage extends EPackageImpl {
	...
	/**
	 * The feature id for the '<em><b>Implicit Fired Rules</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	public static final int SIMPLE_COMPONENT__IMPLICIT_FIRED_RULES = COMPONENT_FEATURE_COUNT + 1;

	/**
	 * The feature id for the '<em><b>Can Be Source Of Failure</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	public static final int SIMPLE_COMPONENT__CAN_BE_SOURCE_OF_FAILURE = COMPONENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	public static final int SIMPLE_COMPONENT_FEATURE_COUNT = COMPONENT_FEATURE_COUNT + 3;
	...
	/**
	 * The feature id for the '<em><b>Raised By Rule</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	public static final int FAILURE__RAISED_BY_RULE = 5;
	 ...
	 * @ordered
	 */
	public static final int FAILURE_FEATURE_COUNT = 6;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link org.polarsys.chess.fla.flamm.SimpleComponent#getImplicitFiredRules <em>Implicit Fired Rules</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Implicit Fired Rules</em>'.
	 * @see org.polarsys.chess.fla.flamm.SimpleComponent#getImplicitFiredRules()
	 * @see #getSimpleComponent()
	 * @generated
	 */
	public EReference getSimpleComponent_ImplicitFiredRules() {
		return (EReference)simpleComponentEClass.getEStructuralFeatures().get(1);
	}


	/**
	 * Returns the meta object for the attribute '{@link org.polarsys.chess.fla.flamm.SimpleComponent#isCanBeSourceOfFailure <em>Can Be Source Of Failure</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Can Be Source Of Failure</em>'.
	 * @see org.polarsys.chess.fla.flamm.SimpleComponent#isCanBeSourceOfFailure()
	 * @see #getSimpleComponent()
	 * @generated
	 */
	public EAttribute getSimpleComponent_CanBeSourceOfFailure() {
		return (EAttribute)simpleComponentEClass.getEStructuralFeatures().get(2);
	}
	...
	/**
	 * Returns the meta object for the reference list '{@link org.polarsys.chess.fla.flamm.Failure#getRaisedByRule <em>Raised By Rule</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Raised By Rule</em>'.
	 * @see org.polarsys.chess.fla.flamm.Failure#getRaisedByRule()
	 * @see #getFailure()
	 * @generated
	 */
	public EReference getFailure_RaisedByRule() {
	...
	public void createPackageContents() {
		...
		createEReference(simpleComponentEClass, SIMPLE_COMPONENT__IMPLICIT_FIRED_RULES);
		createEAttribute(simpleComponentEClass, SIMPLE_COMPONENT__CAN_BE_SOURCE_OF_FAILURE);
		...
		createEReference(failureEClass, FAILURE__RAISED_BY_RULE);
	...
	public void initializePackageContents() {
		...
		initEReference(getSimpleComponent_ImplicitFiredRules(), this.getRule(), null, "implicitFiredRules", null, 0, -1, SimpleComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimpleComponent_CanBeSourceOfFailure(), ecorePackage.getEBoolean(), "canBeSourceOfFailure", "true", 0, 1, SimpleComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFailure_RaisedByRule(), this.getRule(), null, "raisedByRule", null, 0, -1, Failure.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	public interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Implicit Fired Rules</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		public static final EReference SIMPLE_COMPONENT__IMPLICIT_FIRED_RULES = eINSTANCE.getSimpleComponent_ImplicitFiredRules();

		/**
		 * The meta object literal for the '<em><b>Can Be Source Of Failure</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		public static final EAttribute SIMPLE_COMPONENT__CAN_BE_SOURCE_OF_FAILURE = eINSTANCE.getSimpleComponent_CanBeSourceOfFailure();
		...
		/**
		 * The meta object literal for the '<em><b>Raised By Rule</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		public static final EReference FAILURE__RAISED_BY_RULE = eINSTANCE.getFailure_RaisedByRule();

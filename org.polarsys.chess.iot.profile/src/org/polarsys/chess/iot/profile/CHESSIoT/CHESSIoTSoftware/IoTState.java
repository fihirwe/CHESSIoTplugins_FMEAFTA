...
public interface IoTState extends EObject {
	 ...
	 * @generated
	 */
	EList<Action> getOnExit();

	/**
	 * Returns the value of the '<em><b>Internal</b></em>' reference list.
	 * The list contents are of type {@link org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSoftware.InternalEvent}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Internal</em>' reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Internal</em>' reference list.
	 * @see org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSoftware.CHESSIoTSoftwarePackage#getIoTState_Internal()
	 * @model required="true" ordered="false"
	 * @generated
	 */
	EList<InternalEvent> getInternal();

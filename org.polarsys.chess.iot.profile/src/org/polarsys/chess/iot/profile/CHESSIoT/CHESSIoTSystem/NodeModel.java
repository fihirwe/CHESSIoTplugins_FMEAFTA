...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Node Model</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSystem.CHESSIoTSystemPackage#getNodeModel()
 * @model
 * @generated
 */
public enum NodeModel implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Node Model</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final NodeModel[] VALUES_ARRAY =
		new NodeModel[] {
			RASBERRY_PI,
			ARDUINO,
			TEENSY,
	...
	/**
	 * A public read-only list of all the '<em><b>Node Model</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<NodeModel> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Node Model</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static NodeModel get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NodeModel result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Node Model</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static NodeModel getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			NodeModel result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Node Model</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static NodeModel get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private NodeModel(int value, String name, String literal) {
		this.value = value;
		this.name = name;

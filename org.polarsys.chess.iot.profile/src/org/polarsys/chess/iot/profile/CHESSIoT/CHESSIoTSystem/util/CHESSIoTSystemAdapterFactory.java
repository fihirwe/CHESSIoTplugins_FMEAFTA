...
public class CHESSIoTSystemAdapterFactory extends AdapterFactoryImpl {
	...
	protected CHESSIoTSystemSwitch<Adapter> modelSwitch =
		new CHESSIoTSystemSwitch<Adapter>() {
			@Override
			public Adapter casePhysicalBoard(PhysicalBoard object) {
				return createPhysicalBoardAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSystem.PhysicalBoard <em>Physical Board</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createPhysicalBoardAdapter() {
		return null;
	}

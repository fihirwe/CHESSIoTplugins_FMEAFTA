...
public class CHESSIoTDeploymentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CHESSIoTDeploymentPackage.IO_TPORT: {
				IoTPort ioTPort = (IoTPort)theEObject;
				T result = caseIoTPort(ioTPort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CHESSIoTDeploymentPackage.PORT_OUT: {
			...
			case CHESSIoTDeploymentPackage.TAG_UNIT: {

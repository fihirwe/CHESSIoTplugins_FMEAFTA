...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Board Model</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSystem.CHESSIoTSystemPackage#getBoardModel()
 * @model
 * @generated
 */
public enum BoardModel implements Enumerator {
	/**
	...
	/**
	 * The '<em><b>Things Board</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #THINGS_BOARD_VALUE
	 * @generated
	 * @ordered
	 */
	THINGS_BOARD(5, "ThingsBoard", "ThingsBoard"),
	...
	/**
	 * The '<em><b>Things Board</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Things Board</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #THINGS_BOARD
	 * @model name="ThingsBoard"
	 * @generated
	 * @ordered
	 */
	public static final int THINGS_BOARD_VALUE = 5;
	...
	/**
	 * An array of all the '<em><b>Board Model</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final BoardModel[] VALUES_ARRAY =
		new BoardModel[] {
			RASBERRY_PI,
			ARDUINO,
			TEENSY,
	...
	/**
	 * A public read-only list of all the '<em><b>Board Model</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<BoardModel> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Board Model</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static BoardModel get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			BoardModel result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Board Model</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static BoardModel getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			BoardModel result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Board Model</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static BoardModel get(int value) {
		switch (value) {
			...
			case THINGS_BOARD_VALUE: return THINGS_BOARD;
	 ...
	 * @generated
	 */
	private BoardModel(int value, String name, String literal) {
		this.value = value;
		this.name = name;

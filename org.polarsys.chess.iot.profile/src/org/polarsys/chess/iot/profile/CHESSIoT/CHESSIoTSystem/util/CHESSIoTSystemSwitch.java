...
public class CHESSIoTSystemSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CHESSIoTSystemPackage.COMPUTING_BOARD: {
				ComputingBoard computingBoard = (ComputingBoard)theEObject;
				T result = caseComputingBoard(computingBoard);
				if (result == null) result = casePhysicalElement(computingBoard);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Computing Board</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Computing Board</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComputingBoard(ComputingBoard object) {
		return null;
	}

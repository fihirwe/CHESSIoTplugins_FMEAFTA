...
package org.polarsys.chess.iot.deployment.editor.xtext;
...
public class XtextInputDialog extends Dialog {
  ...
  protected Control createDialogArea(Composite parent) {
      ...
      if( this.xtextEnabled ) {
    	...
    	Injector injector = RuntimedslActivator.getInstance().getInjector(RuntimedslActivator.ORG_POLARSYS_CHESS_IOT_RUNTIMEDSL);
    	  
    	IoTDeploymentExpressionsProvider provider =  injector.getInstance(IoTDeploymentExpressionsProvider.class);

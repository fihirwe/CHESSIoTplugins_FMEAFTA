 ...
 *   <li>{@link org.polarsys.chess.iot.profile.CHESSIoT.CHESSIoTSoftware.impl.VirtualElementImpl#getIotstate <em>Iotstate</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VirtualElementImpl extends MinimalEObjectImpl.Container implements VirtualElement {
	...
	/**
	 * The cached value of the '{@link #getIotstate() <em>Iotstate</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIotstate()
	 * @generated
	 * @ordered
	 */
	protected StateMachine iotstate;
	 ...
	 * @generated
	 */
	public StateMachine getIotstate() {
		return iotstate;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetIotstate(StateMachine newIotstate, NotificationChain msgs) {
		StateMachine oldIotstate = iotstate;
		iotstate = newIotstate;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CHESSIoTSoftwarePackage.VIRTUAL_ELEMENT__IOTSTATE, oldIotstate, newIotstate);
	 ...
	 * @generated
	 */
	public void setIotstate(StateMachine newIotstate) {
		if (newIotstate != iotstate) {
			NotificationChain msgs = null;
			if (iotstate != null)
				msgs = ((InternalEObject)iotstate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CHESSIoTSoftwarePackage.VIRTUAL_ELEMENT__IOTSTATE, null, msgs);
			if (newIotstate != null)
				msgs = ((InternalEObject)newIotstate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CHESSIoTSoftwarePackage.VIRTUAL_ELEMENT__IOTSTATE, null, msgs);
			msgs = basicSetIotstate(newIotstate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CHESSIoTSoftwarePackage.VIRTUAL_ELEMENT__IOTSTATE, newIotstate, newIotstate));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CHESSIoTSoftwarePackage.VIRTUAL_ELEMENT__IOTSTATE:
				return basicSetIotstate(null, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CHESSIoTSoftwarePackage.VIRTUAL_ELEMENT__IOTPORT:
				...
				return;
			case CHESSIoTSoftwarePackage.VIRTUAL_ELEMENT__IOTSTATE:
				setIotstate((StateMachine)newValue);
				return;
		}
